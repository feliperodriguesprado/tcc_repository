 ...
 */
package br.com.smom.financial.api.enums;
...
public enum FinancialMessages implements Messages {
    ...
    INFO_GET_FINANCIAL_RELEASE_LIST(0, ""),
    INFO_GET_FINANCIAL_RELEASE(0, ""),
    INFO_CREATE_FINANCIAL_RELEASE(0, ""),
    ...
    private FinancialMessages(int code, String message) {
        this.code = code;
