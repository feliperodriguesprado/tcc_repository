...
@XmlRootElement
@XmlType(propOrder = {"release", "responseResource"})
public class FinancialReleaseTO {

    private FinancialEntity release;
    private ResponseResourceTO responseResource;

    public FinancialEntity getRelease() {
        return release;
    }

    public void setRelease(FinancialEntity release) {
