package prototypes.smom.main.home.servlet;
...
import prototypes.smom.control.base.controller.BundlesControl;
...
public class Servlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            User user = (User) bundlesControl.getBundleService(User.class);
